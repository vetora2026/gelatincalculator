        ...
        <label className="block">
          ...
          <div className="flex flex-col sm:flex-row gap-2">
            <select
              ...
              className="w-full sm:w-auto min-w-0 rounded-lg border border-stone-300 px-2 py-2.5 text-stone-900 focus:border-amber-500 focus:ring-2 focus:ring-amber-200 outline-none transition"
            >
            ...
            <input
              ...
              className="w-full min-w-0 rounded-lg border border-stone-300 px-3 py-2.5 text-stone-900 focus:border-amber-500 focus:ring-2 focus:ring-amber-200 outline-none transition"
            />
          </div>
        </label>
